...
abstract class $UserResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? avatar, String? username, String? email});
}
...
class _$_UserResponse implements _UserResponse {
  const _$_UserResponse({this.avatar, this.username, this.email});
  ...
  @override
  String toString() {
    return 'UserResponse(avatar: $avatar, username: $username, email: $email)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, avatar, username, email);
...
abstract class _UserResponse implements UserResponse {
  const factory _UserResponse(
      {final String? avatar,
      final String? username,
      final String? email}) = _$_UserResponse;
